...
+
** Clústeres solo `NORMAL` se utilizan en los estados y. `SWITCHOVER` Otros estados, como `PARTIAL_SWITCHOVER, PARTIAL_SWITCHBACK` , y `NOT_REACHABLE` no son compatibles.
