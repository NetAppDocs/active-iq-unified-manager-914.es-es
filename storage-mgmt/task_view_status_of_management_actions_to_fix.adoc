...
.Pasos
. Haga clic en *acciones de administración* en el panel de navegación izquierdo. Alternativamente, haga clic en image:../media/more_icon.gif["icono más"]la parte superior del panel *Acciones de administración* en el *Panel* y seleccione la Vista que desea ver.
+
