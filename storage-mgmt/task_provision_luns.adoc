...
[NOTE]
====
A menos que active esta casilla de control, el PSL no se aplica a la carga de trabajo y el estado de la carga de trabajo en el panel aparece como `unassigned`.
