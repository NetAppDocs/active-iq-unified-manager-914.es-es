...
+
La copia Snapshot básica es la copia Snapshot que se usa para crear el volumen FlexClone y muestra el estado `Busy` y la dependencia de la aplicación como `Busy, Vclone` en el volumen principal.
