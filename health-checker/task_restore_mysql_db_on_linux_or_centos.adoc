...
+
Se recomienda copiar el archivo de copia de seguridad en el directorio predeterminado /`data/ocum`-backup. Los archivos del repositorio de la base de datos se deben copiar en /`database-dumps-repo`el subdirectorio del /`ocum-backup` directorio.
