...
. Guarde la vista con un nombre específico que refleje lo que se muestra la vista, por ejemplo «`Capacidad de LUN sin asignar más » y haga clic en la marca de verificación (image:../media/blue_check.gif[""]).
