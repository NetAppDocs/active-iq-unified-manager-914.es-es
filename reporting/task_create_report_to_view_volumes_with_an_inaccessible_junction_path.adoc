...
. Guarde la vista con un nombre específico que refleje lo que muestra la vista, por ejemplo «`Volúmenes con una ruta de montaje inaccesible » y haga clic en la marca de verificación (image:../media/blue_check.gif[""]).
