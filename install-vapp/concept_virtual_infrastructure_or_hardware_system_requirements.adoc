...
Además, existe un límite en el número de nodos que una sola instancia de Unified Manager puede supervisar antes de instalar una segunda instancia de Unified Manager. Para más información, consulta link:https://www.netapp.com/pdf.html?item=/media/13504-tr4621.pdf["Guía de prácticas recomendadas de Unified Manager"^].
