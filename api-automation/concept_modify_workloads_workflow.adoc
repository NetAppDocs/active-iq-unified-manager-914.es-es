...
[NOTE]
====
Puede recuperar los detalles de los niveles de servicio de rendimiento definidos por el sistema definiendo `system_defined` el parámetro de entrada en `true`. En el resultado, obtenga la clave del nivel de servicio de rendimiento que desea aplicar al recurso compartido de archivos.
