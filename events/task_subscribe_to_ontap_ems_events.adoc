...
+
Para ver los nombres de los eventos de EMS a los que puede suscribirse, en el shell del clúster de ONTAP, puede usar `event route show` el comando (antes de ONTAP 9) o `event catalog show` el comando (ONTAP 9 o posterior).
