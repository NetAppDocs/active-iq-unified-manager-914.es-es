...
.. En el campo Contiene el nombre del evento, introduzca *`latency`* y, a continuación, haga clic en la flecha para seleccionar todos los eventos coincidentes.
.. En el campo Contiene el nombre del evento, introduzca *`iops`* y, a continuación, haga clic en la flecha para seleccionar todos los eventos coincidentes.
.. En el campo Contiene el nombre del evento, introduzca *`mbps`* y, a continuación, haga clic en la flecha para seleccionar todos los eventos coincidentes.
