...
[NOTE]
====
WFA 5,1 incluye el ««WFA Pack para gestionar Clustered Data ONTAP», por lo que no es necesario descargar este paquete desde el Almacén de automatización del almacenamiento de NetApp e instalarlo por separado en su servidor WFA como era necesario anteriormente.  https://automationstore.netapp.com/pack-list.shtml["PAQUETE WFA para gestionar ONTAP"]
