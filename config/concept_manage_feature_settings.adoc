...
====
Para obtener más información sobre la carga de scripts, consulte link:task_enable_and_disable_ability_to_upload_scripts.html["Habilitar y deshabilitar la carga de scripts"].
