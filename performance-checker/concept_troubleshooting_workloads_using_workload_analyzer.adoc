...
* Desde cualquier página de inventario de cargas de trabajo (volumen, LUN, carga de trabajo, recurso compartido de NFS o recurso compartido de SMB/CIFS), haciendo clic en el icono Más image:../media/more_icon.gif[""]y luego en *Analizar carga de trabajo*
