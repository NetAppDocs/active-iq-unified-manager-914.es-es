...
+
En la línea de tiempo de sucesos, un punto rojo (image:../media/opm_incident_icon_png.gif["Icono de incidente de Performance Manager"]) indica cuándo se produjo el evento de fallo de disco.
