...
Para obtener más información sobre cómo ajustar la configuración de QoS, consulte http://docs.netapp.com/ontap-9/topic/com.netapp.doc.pow-perf-mon/home.html["Información general sobre gestión del rendimiento"]
