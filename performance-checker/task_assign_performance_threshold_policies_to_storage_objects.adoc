...
Todos los objetos de la página
 a| 
El image:../media/select_dropdown_65_png.gif["seleccione el icono desplegable"]cuadro desplegable, y elija *Seleccionar todos los objetos en esta página*.
...
Todos los objetos del mismo tipo
 a| 
El image:../media/select_dropdown_65_png.gif["seleccione el icono desplegable"]cuadro desplegable, y elija *Seleccionar todos los objetos*.
